...
angular.module('voiceUp').
    factory('semantria', ['$q',
        function ($q) {
            ...
            var SemantriaActiveSession = new Semantria.Session(consumerKey, consumerSecret, "myApp");
...
//                    logger.success('Simetria responded!');
                },

                onAfterResponse: function () {
                    deferred.resolve(SemantriaActiveSession.getProcessedDocuments());
...
//        }
            ...
            return {
                ...
                make: function (text) {
                    ...
                    SemantriaActiveSession.queueDocument({
                        id: id,
                        text: text
                    });
